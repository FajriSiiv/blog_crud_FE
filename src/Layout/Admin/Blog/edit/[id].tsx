...
export default function EditBlog() {
  ...
  return (
    <div className="flex justify-center flex-col items-center container h-full mx-auto relative py-10">
      ...
      <h2 className="text-3xl font-semibold tracking-wide">Ubah Blog</h2>
      {blog && (
        <form
          action=""
      ...
      {blog && (
        <div className="rounded-md border-2 py-2 px-3 fixed right-4 top-10 w-[20%]">
          <h2>Detail Blog</h2>
          <p>Create : {moment(blog.createdAt).startOf("hour").fromNow()}</p>
          <p>Last Update : {moment(blog.updateAt).startOf("hour").fromNow()}</p>

          <button
            className="py-2 px-5 bg-rose-500 mt-2 text-white rounded-md"
